...
/*
Package soterutil provides soter-specific convenience functions and types.

Block Overview

A Block defines a soter block that provides easier and more efficient
...
A Tx defines a soter transaction that provides more efficient manipulation of
