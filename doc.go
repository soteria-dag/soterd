...
/*
soterd is a full-node Block DAG implementation written in Go.

The default options are sane for most users.  This means soterd will work 'out of
...
parsed when soterd starts up.  By default, the configuration file is located at
~/.soterd/soterd.conf on POSIX-style operating systems and %LOCALAPPDATA%\soterd\soterd.conf
...
Application Options:
  ...
  -a, --addpeer=            Add a peer to connect with at startup
      ...
      --listen=             Add an interface/port to listen for connections
                            (default all interfaces port: 8333, testnet: 5070)
  ...
  -P, --rpcpass=            Password for RPC connections
      ...
      --rpclisten=          Add an interface/port to listen for RPC connections
                            (default port: 8334, testnet: 5071)
  ...
  -d, --debuglevel=         Logging level for all subsystems {trace, debug,
      ...
      --maxorphantx=        Max number of orphan transactions to keep in memory
                            (100)
      --generate            Generate (mine) soter tokens using the CPU
