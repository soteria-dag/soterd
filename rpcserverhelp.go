...
var helpDescsEnUS = map[string]string{
	...
	// GetBlockFeeCmd
	"getblockfee--synopsis": "Calculate the fee reward for block",
	"getblockfee-hash": "Block hash",
	"getblockfee--result0": "Block fee",

	// GetBlockFeeAncestors
	"getblockfeeancestors--synopsis": "Returns the ancestor blocks a block should include fee rewards for",
	"getblockfeeancestors-hashes": "Parent block hashes of proposed block",
	"getblockfeeancestors-height": "Height of proposed block",

	// GetBlockFeeAncestors Result
	"getblockfeeancestorsresult-hashes": "Hashes of ancestor blocks",
...
var rpcResultTypes = map[string][]interface{}{
	...
	"getblockfee":           {(*int64)(nil)},
	"getblockfeeancestors":  {(*soterjson.GetBlockFeeAncestorsResult)(nil)},
