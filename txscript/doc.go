...
/*
Package txscript implements the soter transaction script language.

It is currently identical to the Bitcoin Script language. A complete description
of the script language used by bitcoin can be found at
...
soter transaction scripts.

Script Overview

Soter transaction scripts are written in a stack-base, FORTH-like language.

The soter script language consists of a number of opcodes which fall into
...
The vast majority of Soter scripts at the time of this writing are of several
...
what conditions must be met in order to spend soter tokens.
